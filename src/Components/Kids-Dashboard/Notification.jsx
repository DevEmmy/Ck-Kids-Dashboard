    ...
    const dummy = [
        {
            ...
            details: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Optio officiis odio repudiandae vitae expedita sapiente sit consectetur quidem facere numquam.",
            type: 1,
        },
        {
        ...
        <div className='grid gap-4'>
            {
                dummy.map((data, i)=>{
                    return(
                       <NotificationModule data={data} key={i}/>
                    )
                })
            }
        </div>
...
const NotificationModule = ({data})=>{
    ...
    return(
        ...
        <div className='w-[80%]'>
            <p className='' onClick={()=> setShowDetails(!showDetails)}>
                {
                    data.title
                }
            </p>
