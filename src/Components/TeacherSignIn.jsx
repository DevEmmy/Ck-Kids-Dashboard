  ...
  return (
    <>
      <div className="h-full w-full flexss flex-wrap">
        <div
          className={`w-[45%] h-full bg-primary1 py-[4em] sm:py-[2em] px-[5em] text-sec2 sm:px-[1.5em] md1:w-full`}
        >
          <div className="cflexss gap-[1.5em]">
            ...
            >
              <img src="whitelogo.svg" alt="CSkidz" />
            </a>
            <div>
        ...
        <div className="w-[50%] h-full bg-white py-[6em] sm:py-[2em] pl-[6em] pr-[7em] sm:px-[1.5em] md1:w-full">
          <div className="cflexss w-full gap-[28px]">
            ...
            <form className="cflexss gap-[1em] w-full" method="POST">
              ...
              <button
                type="submit"
                className="flexmm gap-[0.5em] rounded-[2em] bg-primary1 px-[2.5em] py-[1em] text-white text-[18px] sm:text-[1rem] font-[600] sm:font-[400]"
