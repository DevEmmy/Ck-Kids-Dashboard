...
const Contact = () => {
  ...
  return (
    <>
      <NavBar active={2} />
      <div className="flexbm pt-[100px] sm:pt-[60px] font-sans w-full lf:justify-center px-xpadding lf:gap-[50px] sm1:px-[1.5em] py-[4em] sm1:pb-[2em] font-[400] text-[20px] lg:text-[18px] ls:text-[16px] sm1:pt-[0em] bg-[#FFF9D2] h-full lf:flex-wrap">
          ...
          <div className="w-full cflexss gap-[40px] lf:pt-[1em]">
            <div className="w-full flexbs flex-wrap sm:gap-[1em]">
              <div className="cflexss gap-[6px] w-[70%] sm:w-full">
                <p className="font-[700] text-[24px] lg:text-[22px] sm:text-[24px] sm:pb-[1em]">Business Hours:</p>
                <p>Monday to Friday: 9:00 AM - 6:00 PM (WAT)</p>
                <p>Saturday and Sunday: Closed</p>
              </div>

              <div className="cflexss gap-[6px] w-[30%] sm:w-full">
                <p className="font-[700] text-[24px] lg:text-[22px] sm:text-[24px] sm:pb-[1em]">Headquaters:</p>
            ...
            <div className="w-full flexbs flex-wrap sm:gap-[1em]">
              <div className="cflexss gap-[6px] w-[70%] sm:w-full">
                <p className="font-[700] text-[24px] lg:text-[22px] sm:text-[24px] sm:pb-[1em]">Email:</p>
                <p>support@curiouskidz.com.ng</p>
              </div>

              <div className="cfledxdmm gap-[6px] w-[30%] sm:w-full">
                <p className="font-[700] text-[24px] lg:text-[22px] sm:text-[26px] sm:pb-[1em]">Phone:</p>
        ...
        <div className="flexms h-[100%] w-[40%] lg:w-[43%] ls:w-[45%] lf:w-full flex-shrink font-[400]">
          <div className="cflexss gap-[1em] w-[100%] p-[1.5em] px-[2em] sm:px-[1em] bg-sec2">
