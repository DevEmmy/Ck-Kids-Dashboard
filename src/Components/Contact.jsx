...
const Contact = () => {
  ...
  return (
    <>
      <NavBar active={2} />
      <div className="flexbm font-sans w-full lf:justify-center px-xpadding lf:gap-[50px] sm1:px-[1.5em] py-[4em] sm1:pb-[2em] font-[400] text-[20px] lg:text-[18px] ls:text-[16px] sm1:pt-[0em] bg-sec6 h-full lf:flex-wrap">
