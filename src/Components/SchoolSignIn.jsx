...
import { schoolLogin, studentLogin } from "@/services/request";
...
const SchoolSignIn = ({ setLoginType, setForgot }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (valid) {
      ...
      await schoolLogin(dispatch, loginDetails.email, loginDetails.password);
      setLoading(false);
    }
  };
  return (
    <>
      <div className="cflexss w-full gap-[28px]">
        ...
        <form className="cflexss gap-[1em] w-full" method="POST">
          ...
          <button
            type="submit"
            className="flexmm gap-[0.5em] rounded-[2em] bg-primary3 px-[2.5em] py-[1em] text-white text-[18px] sm:text-[1rem] font-[600] sm:font-[400]"
        ...
        <div className="text-[16px] lg:text-[14px] sm:text-[18rem] font-[400]">
          <p>
            ...
            <a href="/signup">
              <span className="text-primary3 font-[700] cursor-pointer">
                Create free account
              </span>
            </a>
          </p>
