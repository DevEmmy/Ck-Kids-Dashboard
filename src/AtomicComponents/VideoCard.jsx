  ...
  return (
    <>
      <a href="/" className="w-[350px] flex-shrink sm:w-full">
        <div className="w-full border-[1px] border-[#E6E6E6] cflexbs gap-[20px] min-h-[22em] lg:min-h-[26em] p-[10px] rounded-[24px] cursor-pointer">
          <div className="w-full flexmm h-[218px] self-stretch">
            <img
              src={`${image}.svg`}
              alt={`${image}`}
          ...
          <div className="w-full cflexss gap-[12px]">
            ...
            <p className="text-[16px] leading=[22px] sm:text-[19px] font-[400] text-[#667085] line-clamp-3">
              {content}
            </p>
