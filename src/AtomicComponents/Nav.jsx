    ...
    <div className='flex px-xPadding items-center justify-between mt-[10px] border-b-gray-300 border-b pb-[20px]'>
        ...
        <div className='flex gap-[30px] w-[50%]'>
            ...
            navItems.map((item, index)=>{
                return(
                    <div key={index} className={`flex gap-1 items-center gap-[5px] p-[10px] rounded-lg cursor-pointer ${active === index && item.color}`}>
        ...
        <div className='flex items-center gap-[20px]'>
            ...
            <div className='flex gap-[7px] items-center cursor-pointer'>
                <img src="https://www.looper.com/img/gallery/inosukes-powers-from-demon-slayer-explained/intro-1620465501.jpg" className='w-[30px] h-[30px] rounded-md'/>
                <FiChevronDown />
            </div>
        </div>
