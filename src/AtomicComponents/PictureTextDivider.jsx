...
const PictureTextDivider = ({imageUrl, imageContainerClassNames, imageClassNames, imageFirst = false, children, bgColor}) => {
  return (
    <div className={`flex ${imageFirst ? "flex-row md1:flex-col-reverse" : "flex-row-reverse md1:flex-col-reverse"} ${bgColor} px-[10.2%] md1:px-xpadding items-center pt-[5em] md1:pt-0 py-[107px] md1:pb-[2em] gap-[97px] md1:gap-[2em]`}>
