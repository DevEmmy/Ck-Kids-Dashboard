...
const Board = () => {
    const ld = [
        {
            rank: 1,
            avatar: "https://www.looper.com/img/gallery/inosukes-powers-from-demon-slayer-explained/intro-1620465501.jpg",
    ...
    <div className='text-black w-full flex flex-col border rounded-3xl p-6'>
        ...
        <div>
            <div className='flex justify-between text-start tHead'>
                ...
                <div className='flex gap-2 w-[20%] justify-end text-end'> <IoDiamondOutline size={20} className='text-primary3'/> Learning Gem</div>
            </div>
        </div>
            ...
            
                {
                    ld.map((data, i)=>{
                        return(
                            ...
                            <div className={`tRow py-3 px-2 rounded-lg flex justify-between ${i === 0 && "bg-primary2 text-white"}`} key={i}>
                                ...
                                <div className={`w-[20%] text-[600] text-end  ${i === 0 ? "text-primary1": "text-primary2"}`}>{data.gem}</div>
                            </div>
                        )
                    })
                }
